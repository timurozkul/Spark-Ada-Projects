...
package ada_main is
   ...
   u00001 : constant Version_32 := 16#a30a9d44#;
   ...
   u00005 : constant Version_32 := 16#f042949a#;
   pragma Export (C, u00005, "global_variablesS");
   u00006 : constant Version_32 := 16#4d2bb56a#;
   pragma Export (C, u00006, "power_grid_energy_stabilizerB");
   u00007 : constant Version_32 := 16#7b49db15#;
   pragma Export (C, u00007, "power_grid_energy_stabilizerS");
   u00008 : constant Version_32 := 16#a72e2afe#;
   pragma Export (C, u00008, "as_io_wrapperB");
   u00009 : constant Version_32 := 16#3f5aa9b8#;
   pragma Export (C, u00009, "as_io_wrapperS");
   u00010 : constant Version_32 := 16#28ccd8e8#;
   pragma Export (C, u00010, "sparkS");
   u00011 : constant Version_32 := 16#76789da1#;
   pragma Export (C, u00011, "adaS");
   u00012 : constant Version_32 := 16#f4e097a7#;
   pragma Export (C, u00012, "ada__text_ioB");
   u00013 : constant Version_32 := 16#3913d0d6#;
   pragma Export (C, u00013, "ada__text_ioS");
   u00014 : constant Version_32 := 16#d90c4a0d#;
   pragma Export (C, u00014, "ada__exceptionsB");
   u00015 : constant Version_32 := 16#16307b94#;
   ...
   u00024 : constant Version_32 := 16#40b73bd0#;
   ...
   u00027 : constant Version_32 := 16#75bf515c#;
   pragma Export (C, u00027, "system__soft_links__initializeB");
   u00028 : constant Version_32 := 16#5697fc2b#;
   pragma Export (C, u00028, "system__soft_links__initializeS");
   u00029 : constant Version_32 := 16#41837d1e#;
   pragma Export (C, u00029, "system__stack_checkingB");
   u00030 : constant Version_32 := 16#86e40413#;
   pragma Export (C, u00030, "system__stack_checkingS");
   u00031 : constant Version_32 := 16#34742901#;
   pragma Export (C, u00031, "system__exception_tableB");
   u00032 : constant Version_32 := 16#55f506b9#;
   pragma Export (C, u00032, "system__exception_tableS");
   u00033 : constant Version_32 := 16#ce4af020#;
   pragma Export (C, u00033, "system__exceptionsB");
   u00034 : constant Version_32 := 16#6038020d#;
   pragma Export (C, u00034, "system__exceptionsS");
   u00035 : constant Version_32 := 16#69416224#;
   pragma Export (C, u00035, "system__exceptions__machineB");
   u00036 : constant Version_32 := 16#d27d9682#;
   ...
   u00038 : constant Version_32 := 16#76d1963f#;
   ...
   u00044 : constant Version_32 := 16#0800998b#;
   pragma Export (C, u00044, "system__traceback_entriesS");
   u00045 : constant Version_32 := 16#bb296fbb#;
   pragma Export (C, u00045, "system__traceback__symbolicB");
   u00046 : constant Version_32 := 16#c84061d1#;
   ...
   u00049 : constant Version_32 := 16#a0d3d22b#;
   pragma Export (C, u00049, "system__address_imageB");
   u00050 : constant Version_32 := 16#a9b7f2c1#;
   ...
   u00059 : constant Version_32 := 16#9ce1eefb#;
   ...
   u00079 : constant Version_32 := 16#ec083f01#;
   pragma Export (C, u00079, "system__file_ioB");
   u00080 : constant Version_32 := 16#af2a8e9e#;
   ...
   u00083 : constant Version_32 := 16#47a91c6b#;
   pragma Export (C, u00083, "system__finalization_rootS");
   u00084 : constant Version_32 := 16#e4774a28#;
   pragma Export (C, u00084, "system__os_libB");
   u00085 : constant Version_32 := 16#d8e681fb#;
   pragma Export (C, u00085, "system__os_libS");
   u00086 : constant Version_32 := 16#2a8e89ad#;
   pragma Export (C, u00086, "system__stringsB");
   u00087 : constant Version_32 := 16#684d436e#;
   pragma Export (C, u00087, "system__stringsS");
   u00088 : constant Version_32 := 16#f5c4f553#;
   pragma Export (C, u00088, "system__file_control_blockS");
   u00089 : constant Version_32 := 16#440739da#;
   pragma Export (C, u00089, "spark__text_ioB");
   u00090 : constant Version_32 := 16#b96d62e1#;
   pragma Export (C, u00090, "spark__text_ioS");
   u00091 : constant Version_32 := 16#68995fa1#;
   pragma Export (C, u00091, "spark__text_io__integer_ioB");
   u00092 : constant Version_32 := 16#df01d5cd#;
   pragma Export (C, u00092, "spark__text_io__integer_ioS");
   u00093 : constant Version_32 := 16#fdedfd10#;
   pragma Export (C, u00093, "ada__text_io__integer_auxB");
   u00094 : constant Version_32 := 16#2fe01d89#;
   ...
   u00096 : constant Version_32 := 16#305a076a#;
   pragma Export (C, u00096, "ada__text_io__generic_auxS");
   u00097 : constant Version_32 := 16#b10ba0c7#;
   pragma Export (C, u00097, "system__img_biuB");
   u00098 : constant Version_32 := 16#faff9b35#;
   pragma Export (C, u00098, "system__img_biuS");
   u00099 : constant Version_32 := 16#4e06ab0c#;
   pragma Export (C, u00099, "system__img_llbB");
   u00100 : constant Version_32 := 16#bb388bcb#;
   ...
   u00103 : constant Version_32 := 16#a756d097#;
   pragma Export (C, u00103, "system__img_llwB");
   u00104 : constant Version_32 := 16#1254a85d#;
   pragma Export (C, u00104, "system__img_llwS");
   u00105 : constant Version_32 := 16#eb55dfbb#;
   pragma Export (C, u00105, "system__img_wiuB");
   u00106 : constant Version_32 := 16#94be1ca7#;
   pragma Export (C, u00106, "system__img_wiuS");
   u00107 : constant Version_32 := 16#0f9783a4#;
   pragma Export (C, u00107, "system__val_intB");
   u00108 : constant Version_32 := 16#bda40698#;
   pragma Export (C, u00108, "system__val_intS");
   u00109 : constant Version_32 := 16#383fd226#;
   pragma Export (C, u00109, "system__val_unsB");
   u00110 : constant Version_32 := 16#09db6ec1#;
   pragma Export (C, u00110, "system__val_unsS");
   u00111 : constant Version_32 := 16#fb020d94#;
   pragma Export (C, u00111, "system__val_lliB");
   u00112 : constant Version_32 := 16#6435fd0b#;
   ...
   --  as_io_wrapper%s
   --  as_io_wrapper%b
   --  power_grid_energy_stabilizer%s
   --  power_grid_energy_stabilizer%b
   --  main%s
   --  main%b
